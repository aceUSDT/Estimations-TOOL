...
-- Remove the old Vault secret only after the dedicated project Vault secret is verified.
-- select vault.delete_secret(id) from vault.secrets where name='COINGLASS_API_KEY';
