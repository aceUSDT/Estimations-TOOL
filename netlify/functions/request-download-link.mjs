...
import { realStore, getByEmail, isActive } from './lib/entitlements.mjs';
import { sendRestoreEmail, isLocalTestMode } from './lib/email.mjs';
...
export default async function handler(req) {
  ...
  return handleRequestDownloadLink(req, { env: process.env, store: await realStore(), sendRestoreEmail });
}

export const config = { path: '/api/request-download-link' };
