 ...
 */
import { commerceState, json, getStripe } from './lib/commerce.mjs';
import { realStore, fulfil, markRefunded, markEventProcessed } from './lib/entitlements.mjs';
...
export default async function handler(req) {
  ...
  return handleStripeWebhook(req, { env: process.env, store: await realStore(), getStripe });
}
