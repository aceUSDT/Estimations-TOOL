 ...
 */
import { commerceState, json, sha256Hex } from './lib/commerce.mjs';
import { realStore, isActive } from './lib/entitlements.mjs';
...
export default async function handler(req) {
  ...
  return handleRedeemDownloadToken(req, { env: process.env, store: await realStore() });
}

export const config = { path: '/api/redeem-download-token' };
